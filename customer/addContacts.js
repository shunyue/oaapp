...
export default class Info extends Component {
    ...
    _complete() {
        DeviceEventEmitter.emit('addPeople',{con_name: this.state.con_name,tel: this.state.tel,email: this.state.email,department: this.state.department,position: this.state.position});
