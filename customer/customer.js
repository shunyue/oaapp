                ...
                <View>
                    <Modal
                        ...
                        <TouchableWithoutFeedback onPress={() => {this.setState({isModalVisible: !this.state.isModalVisible})}}>
                            <View style={{flex:1}}>
                                <View style={{width:screenW,height:Platform.OS==='ios'?(screenH-269):(screenH-270),opacity:0.4,backgroundColor:'#000',top:Platform.OS==='ios'?210:190,position:'absolute'}}></View>
