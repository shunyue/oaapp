...
export default class select_customer    extends Component {
    ...
    componentDidMount() {
        var url = config.api.base + config.api.select_customer;;
        const {params} = this.props.navigation.state;
        request.post(url,{
    ...
    _confirm() {
       ...
       //console.log( this.state.checkedData);
        DeviceEventEmitter.emit('choosecustomer', this.state.checkedData);
                    ...
                    <TouchableHighlight key={j}
                        ...
                        <View style={styles.listRowContent}>
                            <View style={styles.listRowSide}>
                                ...
                                <Text style={styles.textStyle}>{userData[i][j].cus_name}</Text>
                                </View>
                            </View>
                        </View>
                    </TouchableHighlight>
