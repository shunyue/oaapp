...
export default class return_money_approve extends Component {
    ...
    getNet(){
        ...
        var url = config.api.base + config.api.contract_returnmoney_approve;
        request.post(url,{
            example_id: this.props.navigation.state.params.example_id,//实例id
            ...
            if(responseText.sing==1){
                ...
                this.setState({
                    ...
                    return_money:responseText.contract_returnmoney_info,//回款信息
    ...
    //转交
    pass_on_to(){
        this.props.navigation.navigate('pass_on_to',{user_id:this.props.navigation.state.params.user_id,company_id:this.props.navigation.state.params.company_id,example_id: this.props.navigation.state.params.example_id,approve_type:3})
    }
    ...
    render() {
        ...
        if(this.state.return_money['proof']){

            var imglist_value=this.state.return_money['proof'].split(",");
        ...
        return (
            <View style={styles.ancestorCon}>
                ...
                <ScrollView>
                    ...
                    <View style={[styles.divRowCom,{justifyContent: 'flex-start',marginTop:10}]}>
                        <Text style={[styles.divFontCom,{width: 150}]}>合同回款信息</Text>
                    </View>

                    <View style={[styles.divRowCom,{justifyContent: 'flex-start'}]}>
                        <Text style={[styles.divFontCom,{width: 150}]}>回款金额</Text>
                        <Text style={[styles.divFontCom]}>{this.state.return_money['return_price'] }</Text>
                    </View>
                    <View style={[styles.divRowCom,{justifyContent: 'flex-start'}]}>
                        <Text style={[styles.divFontCom,{width: 150}]}>回款时间</Text>
                        <Text style={[styles.divFontCom]}>{this.state.return_money['time'] }</Text>
                    </View>
                    <View style={[styles.divRowCom,{justifyContent: 'flex-start'}]}>
                        <Text style={[styles.divFontCom,{width: 150}]}>回款说明</Text>
                        <Text style={[styles.divFontCom]}>{this.state.return_money['state'] }</Text>
                    </View>
                    <View style={[styles.divRowCom,{justifyContent: 'flex-start'}]}>
                        <Text style={[styles.divFontCom,{width: 150}]}>汇款账号名称</Text>
                        <Text style={[styles.divFontCom]}>{this.state.return_money['account_name'] }</Text>
                    </View>
                    <View style={[styles.divRowCom,{justifyContent: 'flex-start'}]}>
                        <Text style={[styles.divFontCom,{width: 150}]}>汇款账号号</Text>
                        <Text style={[styles.divFontCom]}>{this.state.return_money['account_nb'] }</Text>
                    </View>
                    <View style={[styles.divRowCom,{justifyContent: 'flex-start'}]}>
                        <Text style={[styles.divFontCom,{width: 150}]}>回款凭证</Text>
                    </View>

                    <View style={{flexDirection:'row',flexWrap:'wrap',paddingBottom:screenW*0.02,  backgroundColor:'#fff'}}>
                        {imglist}
                    </View>
                    ...
                    <View style={[styles.divRowCom,{justifyContent: 'flex-start',marginTop:10}]}>
                        <Text style={[styles.divFontCom,{width: 150}]}>审批详情</Text>
                    </View>
                    <View style={[{flexDirection:'row',alignItems:'center',paddingLeft:15}]}>
