...
export default class Create extends Component {
    ...
    _createCompany() {
        ...
        if(!this.state.company_name.trim()) {
            return toast.bottom('公司名称不能为空')
        }
        if(!this.state.active_code.trim()) {
            return toast.bottom('激活码不能为空')
        }




        var url = config.api.base + config.api.companyRegister;
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.contentContainer}>
                    ...
                    <View style={styles.listRowContent}>
                        <Text style={styles.textStyle}>公司名称</Text>
                        <TextInput
                            ref="5"
                            returnKeyType="next"
                            returnKeyLabel={"下一步"}
                    ...
                    <View style={[styles.listRowContent,{borderBottomWidth: 0}]}>
                        <Text style={styles.textStyle}>激活码</Text>
                        <TextInput
                            ref="6"
                            ...
                            placeholderTextColor ={"#CFCFCF"}
                            style={styles.inputStyle}
                            onChangeText={(active_code)=>{this.setState({active_code})}}
                        />
                    </View>
                </View>
