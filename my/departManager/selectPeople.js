...
export default class SelectPeople  extends Component {
    ...
    _nextDepart(depart_id,depart_name) {
        ...
        const {params} = this.props.navigation.state;
        this.props.navigation.navigate('SelectPeople',{depart_id :params.depart_id,depart_name :params.depart_name,high_depart_id: depart_id,high_depart_name: depart_name,company_id: params.company_id,company_name: params.company_name});
    }
    ...
    _confirm() {
        ...
        const {params} = this.props.navigation.state;
        var url = config.api.base + config.api.selectDownUser;
        request.post(url,{
            company_id: params.company_id,
        ...
        this.props.navigation.goBack('SelectPeople');
        ...
        return (
            <View style={styles.container}>
                <Header navigation = {this.props.navigation}
                        title = {"转移员工至"+params.depart_name}/>
